...
const VG_ENDPOINT = 'https://vision.googleapis.com/v1/images:annotate';
const G_NUM_RETURN = '5';

//const VG_API_KEY = 'AIzaSyC-A5v-Ni-5DEUeByv0ASTqIDzSedbVnVY'; //makoto
const VG_API_KEY = 'AIzaSyB_LG4vUd3N38WsJ2PVTeOF8MBunWcs9Go'; //alan
...
const G_CX_BLACKLIST = '008799506537989115616:hi93p5ijwzs'; //alan



module.exports = {
	G_ENDPOINT, VG_ENDPOINT, G_NUM_RETURN, G_API_KEY, VG_API_KEY, G_CX_WHITELIST, G_CX_BLACKLIST 
}
